...
data class LoginPacketIn(
    ...
    private fun isPasswordValid(username: String, plainPassword: String): Boolean {
        ...
        val charactersDir = File("C:/Users/Mika/Desktop/near-reality-server-main/data/characters") //ive changed the location files of the data saves to my own desktop for the local files and lvie files to the dedi location
        ...
        if (!playerFile.exists()) {
            ...
            player.setPlainPassword(plainPassword) //and added planpassword methods to let it save inside the json char files so it saves passwords. thats it
