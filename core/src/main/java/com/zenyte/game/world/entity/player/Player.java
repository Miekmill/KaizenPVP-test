...
//        CoresManager.getServiceProvider().submit(() -> new ApiAdventurersLogRequest(this, icon, message).execute());
    ...
    public int getDonorPoints() {
        return getNumericAttribute("donorPoints").intValue();
    }
    public void setDonorPoints(final int value) {
        addAttribute("donorPoints", value); // Update the donorPoints in the attributes map
    }
    ...
    public int[] getAttunedSigilIds() {
        return new int[]{28525, 26140};
    }
    public int[] getUnattunedSigilIds() {
        return new int[]{28526, 26141};
    }
    ...
    public void setCurrentClan(ClanChannel coxChannel) {
    }
