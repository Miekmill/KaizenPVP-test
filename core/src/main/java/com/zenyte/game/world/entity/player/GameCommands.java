...
public final class GameCommands {
    ...
    static {
        ...
        new Command(PlayerPrivilege.PLAYER, "daily", (player, args) -> {
            ...
            player.sendMessage("You claimed your daily login reward. Come back tomorrow for more!");
        });
...
//            }
        ...
        new Command(PlayerPrivilege.PLAYER, "claimvotes", "Claims your votes for kaizenpvp.", (p, args) -> {
            // Call the Java Votes class method
            Votes.run(p);
        });
        new Command(PlayerPrivilege.PLAYER, "claimdonation", "Claims your Donation for kaizenpvp.", (p, args) -> {
            // Call the Java Votes class method
            Donation.run(p);
        });
        new Command(PlayerPrivilege.PLAYER, new String[]{"store", "donate"}, (player, args) -> {
            String websiteURL = "https://www.kaizenpvp.org/store";
            player.getPacketDispatcher().sendURL(websiteURL);
        });
        new Command(PlayerPrivilege.PLAYER, "vote", "Visit the vote website for KaizenPVP.", (player, args) -> {
            String websiteURL = "https://www.kaizenpvp.org/vote";
            player.getPacketDispatcher().sendURL(websiteURL);
        });
        ...
        new Command(PlayerPrivilege.PLAYER, "2fa", (p, args) -> {
            p.getPacketDispatcher().sendURL("https://kaizenpvp.org/account");
        });
        new Command(PlayerPrivilege.PLAYER, "youtube", (p, args) -> {
            p.getPacketDispatcher().sendURL("https://www.kaizenpvp.org");
        });
