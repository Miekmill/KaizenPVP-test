...
import java.sql.*;
/**
 Edited by Phantom for kaizenPVP
 */
public class Votes {


    public static final String HOST = "93.127.192.86"; // website ip address
    public static final String USER = "kaiz1684_forum";
    public static final String PASS = "Fatfox9999";
    public static final String DATABASE = "kaiz1684_vote";
    ...
    public static void run(Player player) {
        try {
            ...
            while (rs.next()) {
                ...
                // Reward logic
                player.getInventory().addItem(32148, 3); // vote shard reward
                count++;
            ...
            if (count >= 2) {
                player.getInventory().addItem(6199, 2); // mystery box reward
