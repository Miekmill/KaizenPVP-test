...
public final class ClanChannel {
	 ...
	 */
	void loadOwner(@NotNull final Consumer<Player> consumer) { //if you dont know its ok, maybe i can see for another problem? sec im checking my source some stuff could be different ok
		/*if (ownerPlayer == null) {
