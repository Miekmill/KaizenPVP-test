...
public class GameConstants {
	...
	public static final String SERVER_WEBSITE_URL = "https://kaizenpvp.org";
	...
	public static final String DISCORD_INVITE = "https://discord.gg/KaizenPVP";
	 ...
	 */
	public static final boolean REGISTER_ON_FORUMS = false;//I think you may have changed to much my friend. mmm alright our only differences are login/saving which would be why its not working cause its not saving it to the player for the server to grab it from the player if that makes sense yeah
	...
	public static final String UPDATE_LOG_URL = "discord.gg/KaizenPVP";
