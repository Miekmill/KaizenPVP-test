...
class SpawnsSpawns : NPCSpawnsScript() {
	init {
		...
		NEARREALITY_GUIDE(3087, 3489, 0, SOUTH, 1)

		if (ContentConstants.CHRISTMAS) {
			SANTA_CLAUS(3096, 3485, 0, NORTH, 0)
		}
		16064(3080, 3486, 0, NORTH, 0)
		14900(3101, 3487, 0, WEST, 0)
		KING_THOROS(3100, 3500, 0, EAST, 0)
		KRYSTILIA(3109, 3517, 0, NORTH, 0)
		SHOP_KEEPER_2821(3079, 3511, 0, SOUTH, 1)
		HATIUS_COSAINTUS(3095, 3504, 0, SOUTH, 2)
//SHOP_ASSISTANT_2822(3087, 3506, 0, SOUTH, 1)
//AIVAS(3075, 3508, 0, EAST, 0)
//DHALIUS(3075, 3509, 0, EAST, 0)
		HERQUIN(3074, 3511, 0, EAST, 0)
		JOHN_16007(3074, 3510, 0, EAST, 0) // John
		BABA_YAGA(3074, 3509, 0, EAST, 0)
		FAE(3074, 3508, 0, EAST, 0)
		TRISTAN(3074, 3512, 0, EAST, 0)
//ARNAS(3076, 3512, 0, SOUTH, 0)
		BANKER_2117(3090, 3498, 0, NORTH, 0)
		BANKER_2117(3091, 3498, 0, NORTH, 0)
		BANKER_2118(3090, 3495, 0, SOUTH, 0)
		BANKER_2118(3091, 3495, 0, SOUTH, 0)
		GRAND_EXCHANGE_CLERK(3089, 3496, 0, WEST, 0)
		GRAND_EXCHANGE_CLERK_2150(3092, 3497, 0, EAST, 0)
		GRAND_EXCHANGE_CLERK_2149(3092, 3496, 0, EAST, 0)
		GRAND_EXCHANGE_CLERK_2151(3089, 3497, 0, WEST, 0)
		CHALLENGE_HEADMASTER(3099, 3500, 0, WEST, 0)
//HEAD_CHEF(3094, 3462, 0, SOUTH, 2)
		HARI(3131, 3507, 0, SOUTH, 2)
		LESSER_FANATIC(3112, 3517, 0, SOUTH, 1)
		LUNA(3115, 3518, 0, SOUTH, 3)
		EMBLEM_TRADER(3103, 3509, 0, EAST, 0)
		ZAHUR(3086, 3513, 0, WEST, 0)
		16034(3086, 3511, 0, WEST, 0) // Primula
		OZIACH(3103, 3513, 0, EAST, 0)
		NULODION(3098, 3482, 0, SOUTH, 1)
//TOOL_LEPRECHAUN(3107, 3498, 0, SOUTH, 1)
		SKULLY(3102, 3515, 0, NORTH, 0)
		IMP_5007(3073, 3493, 0, SOUTH, 50)
		IMP_5007(3078, 3461, 0, SOUTH, 50)
		IMP_5007(3104, 3486, 0, SOUTH, 50)
		PEKSA(3078, 3420, 0, SOUTH, 2)
		PROBITA(3104, 3491, 0, WEST, 0)
		JOSSIK(3104, 3489, 0, WEST, 0)
		MAC(3105, 3514, 0, SOUTH, 0)
		WISE_OLD_MAN(3112, 3508, 0, NORTH, 0)
		IRON_MAN_TUTOR(3083, 3508, 0, NORTH, 0)
//7457(3078, 3512, 0, SOUTH, 0) // Perdu
		FRANK(3099, 3497, 0, WEST, 0)
		MAKEOVER_MAGE(3080, 3495, 0, NORTH, 0)
		GHOMMAL(3103, 3492, 0, SOUTH, 0)
		16065(3115, 3509, 0, WEST, 4)
		996(2717, 5310, 0, SOUTH, 3)

		WATSON(3088, 3469, 0, NORTH, 2)
...
/*		COMBAT_DUMMY_16019(3081, 3486, 0, SOUTH)
		...
		DUSURI(3102, 3492, 0, SOUTH)

		MADAM_SIKARO(3152, 3642, 0, SOUTH, 0)

		ELLIS(3085, 3514, walkRadius = 0)
	}
}
